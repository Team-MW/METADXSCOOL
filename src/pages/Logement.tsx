                        ...
                        <div className="campus-wrapper">
                            <div>
                                ...
                                <div className="contact-item">
                                    <MapPin size={24}/>
                                    <p><a href="https://maps.google.com/?q=244+Route+de+Seysses,+Bâtiment+2,+31100+Toulouse" target="_blank" rel="noopener noreferrer" style={{color:'inherit', textDecoration:'underline'}}><strong>244 Route de Seysses</strong><br/>Bâtiment 2, 4e étage<br/>31100 Toulouse</a></p>
                                </div>
                                <div className="contact-item">
                                    <Phone size={24}/>
