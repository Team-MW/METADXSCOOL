    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Découvrez nos Bachelors de niveau Bac+3 (Niveau 6) accessibles en alternance ou e-learning." />
            </Helmet>
            ...
            <div className="catalogue-page">
                <div className="catalogue-container">
                    <div className="section-header">
                        ...
                        <h1 className="section-title">NOS FORMATIONS NIVEAU BAC+3</h1>
                    </div>
