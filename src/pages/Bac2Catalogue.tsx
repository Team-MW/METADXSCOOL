    ...
    const formations = [
        {
            ...
            description: "Devenez un négociateur hors pair pour le commerce inter-entreprises (B2B). Maîtrisez la prospection, la négociation et la fidélisation client.",
        ...
        {
            title: "TITRE PROFESSIONNEL RPMS",
            subtitle: "Responsable de Petite ou Moyenne Structure",
            description: "Pilotez la gestion opérationnelle, financière et humaine des petites et moyennes entreprises pour accompagner leur croissance.",
            level: "Bac+2 • Niveau 5",
            duration: "12 Mois",
            rhythm: "Alternance ou Initial",
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Découvrez nos titres professionnels de niveau Bac+2 (Niveau 5) accessibles en alternance ou e-learning. Propulsez votre carrière avec Meta DX School." />
            </Helmet>
                ...
                <div className="catalogue-container">
                    ...
                    <header className="hero-section">
                        <span className="top-badge">
                            <GraduationCap size={16} /> Formations Supérieures
                        </span>
                        <h1 className="hero-title">NOS FORMATIONS NIVEAU BAC+2</h1>
                        <p className="hero-subtitle">
                            Découvrez nos titres professionnels de niveau 5 (Bac+2), axés sur le développement de compétences solides en management, négociation commerciale et gestion de structure, disponibles en alternance ou e-learning.
                        </p>
                    </header>
