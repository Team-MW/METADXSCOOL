...
export default function BacCatalogue() {
    const formations = [
        {
            title: "TITRE PROFESSIONNEL CRCD",
            subtitle: "Conseiller Relation Client à Distance",
            description: "Devenez le cœur de la relation client multicanal. Maîtrisez le conseil, l'assistance et la vente à distance dans un secteur en pleine expansion.",
            level: "Bac • Niveau 4",
            duration: "12 Mois",
            rhythm: "Alternance ou Initial",
            path: "/cfa/formation/tp-crcd",
            image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=800&auto=format&fit=crop"
        },
        {
            title: "TITRE PROFESSIONNEL AMUM",
            subtitle: "Assistant Manager d'Unité Marchande",
            description: "Pilotez les ventes, développez l'attractivité commerciale d'un point de vente et managez les équipes de vente de proximité.",
            level: "Bac • Niveau 4",
            duration: "12 Mois",
            rhythm: "Alternance ou Initial",
    ...
    return (
        <>
            <Helmet>
                <title>Formations Niveau Bac | Meta DX School</title>
                <meta name="description" content="Découvrez nos titres professionnels de niveau Bac (Niveau 4) accessibles en alternance ou e-learning. Boostez votre employabilité avec Meta DX School." />
            </Helmet>
                ...
                <div className="catalogue-container">
                    ...
                    <header className="hero-section">
                        <span className="top-badge">
                            <GraduationCap size={16} /> Formations Diplômantes
                        </span>
                        <h1 className="hero-title">NOS FORMATIONS NIVEAU BAC</h1>
                        <p className="hero-subtitle">
                            Découvrez nos titres professionnels de niveau 4 (Niveau Bac), conçus en étroite collaboration avec les recruteurs pour vous offrir une employabilité maximale en alternance ou e-learning.
                        </p>
                    </header>
                            ...
                            <Link key={i} to={f.path} className="formation-card">
                                ...
                                <div className="card-body">
                                    <div className="card-info-header">
                                        ...
                                        <p style={{ color: '#c084fc', fontWeight: 700, fontSize: '0.95rem', marginBottom: '0.75rem', textTransform: 'uppercase' }}>
                                            {f.subtitle}
                                        </p>
