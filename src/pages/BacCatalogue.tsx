    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Découvrez nos titres professionnels de niveau Bac (Niveau 4) accessibles en alternance ou e-learning." />
            </Helmet>
            ...
            <div className="catalogue-page">
                <div className="catalogue-container">
                    <div className="section-header">
                        ...
                        <h1 className="section-title">NOS FORMATIONS NIVEAU BAC</h1>
                    </div>
