...
export default function Bac5Catalogue() {
    const formations = [
        {
            title: "TITRE PROFESSIONNEL MDEC",
            subtitle: "Manager du Développement d'Entreprise et Commercial",
            description: "Devenez un leader stratégique du business development. Structurez la stratégie commerciale globale, pilotez la croissance d'une entreprise et managez les équipes grands comptes.",
            level: "Bac+5 • Niveau 7",
            duration: "12 à 24 Mois",
            rhythm: "Alternance ou Initial",
            path: "/cfa/formation/tp-mdec",
    ...
    return (
        <>
            <Helmet>
                <title>Formations Niveau Bac+5 | Meta DX School</title>
                <meta name="description" content="Découvrez nos Mastères de niveau Bac+5 (Niveau 7) accessibles en alternance ou e-learning. Prenez une dimension managériale supérieure avec Meta DX School." />
            </Helmet>
                ...
                <div className="catalogue-container">
                    ...
                    <header className="hero-section">
                        <span className="top-badge">
                            <GraduationCap size={16} /> Mastère d'Affaires
                        </span>
                        <h1 className="hero-title">NOS FORMATIONS NIVEAU BAC+5</h1>
                        <p className="hero-subtitle">
                            Découvrez notre Mastère d'élite de niveau 7 (Bac+5), conçu pour vous propulser vers des postes de haute direction commerciale, d'ingénierie d'affaires complexes et de pilotage d'entreprise globale, disponible en alternance ou e-learning.
                        </p>
                    </header>
