    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Découvrez nos Mastères de niveau Bac+5 (Niveau 7) accessibles en alternance ou e-learning." />
            </Helmet>
            ...
            <div className="catalogue-page">
                <div className="catalogue-container">
                    <div className="section-header">
                        ...
                        <h1 className="section-title">NOS FORMATIONS NIVEAU BAC+5</h1>
                    </div>
