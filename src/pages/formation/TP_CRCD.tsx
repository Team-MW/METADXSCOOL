                ...
                <div className="main-layout">
                    ...
                    <div className="sidebar">
                        <div className="cta-card">
                            ...
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfaARamzsrRX_7WS5Ix8xMe3HhqCthGECrrR_4BgB3lQObcDw/viewform?pli=1" target="_blank" rel="noopener noreferrer" className="btn-outline">
